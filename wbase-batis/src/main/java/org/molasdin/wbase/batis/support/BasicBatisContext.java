 ...
 */
public class BasicBatisContext<M> implements BatisContext<M> {

    private SqlSession session;
    private M mapper;

    public BasicBatisContext(SqlSession session, M mapper) {
    ...
    public static<F> BatisContext<F> of(SqlSession session, F mapper){
        return new BasicBatisContext<F>(session, mapper);
    }
}
