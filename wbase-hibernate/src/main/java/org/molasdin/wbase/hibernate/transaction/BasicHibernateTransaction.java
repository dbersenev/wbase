 ...
 */
public class BasicHibernateTransaction extends AbstractTransaction<HibernateEngine> {

    private Transaction transaction;

    public BasicHibernateTransaction(HibernateEngine engine, Transaction transaction) {
        super(engine);
