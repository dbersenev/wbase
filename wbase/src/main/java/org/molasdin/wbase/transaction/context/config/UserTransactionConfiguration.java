...
/**
 * Created by dbersenev on 24.03.2016.
 */
public interface UserTransactionConfiguration<T extends Engine> extends TransactionConfiguration {
    void setUnderline(T engine, Transaction tx);
    UserTransaction<T> createTransaction();
}
